...
import 'package:la_barber/core/ui/widgets/sucesso_dialog.dart';
...
class ServicoTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        context.pushNamed(Routes.servicoDetailPage, arguments: servico);
      },
      child: Container(
        width: 200,
        height: 100,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Center(
                          child: IconButton(
                            onPressed: () {
                              ServicoDialog.showPerguntaExcluir(
                                context: context,
                                servico: servico.nome,
                                onPressed: () async {
                                  Navigator.pop(context);
                                  // await servicoRepository.deleteServico(servico.id);
